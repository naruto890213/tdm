...
#define offsetoflist(TYPE, MEMBER)   ((size_t1) &((TYPE *)0)->MEMBER)
 ...
 *
 */
#define container_of(ptr, type, member) (type *)((char *)ptr -offsetoflist(type,member))
 ...
 */
static inline void clist_add(struct list_head *new, struct list_head *head)
{
